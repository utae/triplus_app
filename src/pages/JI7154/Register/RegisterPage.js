        ...
        return (
            <ScrollView
                ...
                <View style={styles.agreeView}>
                    ...
                    <Text style={styles.underLineText} onPress={()=>{this.membershipAndTermsOfService()}}>{'회원가입 및 운영약관'}</Text>
                ...
                <View style={styles.agreeView}>
                    ...
                    <Text style={styles.underLineText} onPress={()=>this.privacyTermsAndConditions()}>{'개인정보 수집 및 이용'}</Text>
                    <Text style={styles.planText}>{' 동의 (필수)'}</Text>
                </View>
                {/*개인정보 수집 끝*/}
